...
public class QuestBookListener implements Listener {
    ...
    @EventHandler
    public void OpenQuestBookListener(PlayerInteractEvent ev) {
        ...
        if(!identifier.getName().equalsIgnoreCase("Quest Book")) { return; }

        s.getQuestBookInventory().openInventory(s);
    }
