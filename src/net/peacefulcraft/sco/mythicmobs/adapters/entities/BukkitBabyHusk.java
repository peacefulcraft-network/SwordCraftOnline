...
public class BukkitBabyHusk extends MythicEntity {
    ...
    public Entity spawn(MythicMob mm, Location location) {
        Zombie e = (Zombie)location.getWorld().spawnEntity(location, EntityType.HUSK);
        e.setBaby(true);
    ...
    public static boolean isInstanceOf(Entity e) {
        if (e instanceof Zombie && e.getType().equals(EntityType.HUSK)) {
